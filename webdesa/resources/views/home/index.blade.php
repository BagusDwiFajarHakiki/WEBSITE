...
<body class="bg-[#E7F0E7] text-gray-900 font-sans">
    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <nav>
        <ul class="flex space-x-6 text-sm font-semibold">
          ...
          <li><a href="#" class="hover:underline hover:text-gray-200">KKN</a></li>
  ...
  <!-- Hero Video Profil Section -->
  <section class="bg-gradient-to-r from-green-600 via-teal-400 to-green-400 p-6 md:p-12 rounded-b-3xl shadow-md relative">
    <div class="max-w-6xl mx-auto">
      <div class="relative rounded-xl overflow-hidden shadow-lg">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/fca49974-1dcb-43aa-a8ba-73459f2e324b.png" 
          alt="Panoramic natural landscape featuring tall mountains under a clear sky with fog rising over lush green forest valleys" 
          class="w-full h-auto object-cover rounded-xl" 
          onerror="this.style.display='none';" />
        <div class="absolute inset-0 bg-black bg-opacity-30 flex justify-center items-center rounded-xl">
  ...
  <!-- Profil Desa Section -->
  <section class="max-w-6xl mx-auto p-6 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-16">
    <div class="flex-shrink-0 relative w-40 md:w-48">
      ...
      <div class="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-tr from-[#0ea5e9] to-[#3b82f6] px-3 py-1 rounded-full text-xs text-white font-semibold text-center shadow-md max-w-[11rem]">
        Suyudi Hariyana M.Pd.<br />
        Kepala Desa Pasiraman
      </div>
    </div>
    <div class="text-gray-900 max-w-3xl relative">
      <h3 class="font-bold text-xl mb-3 select-none">Profil Desa Pasiraman</h3>
  ...
  <!-- Statistik Umum Section -->
  <section class="max-w-6xl mx-auto p-6 md:p-12 bg-black bg-opacity-70 text-white rounded-xl shadow-xl space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-600">
      <div class="flex flex-col space-y-2 border-b border-gray-500 md:border-b-0 md:border-r md:pr-6">
        <p class="text-xs uppercase font-semibold opacity-70 select-none">Jumlah TK/PAUD</p>
        <p class="text-xl font-semibold select-text">110.97 Km2</p>
      </div>
      <div class="flex flex-col space-y-2 border-b border-gray-500 md:border-b-0 md:border-r md:pr-6">
        <p class="text-xs uppercase font-semibold opacity-70 select-none">Jumlah SDN</p>
        <p class="text-xl font-semibold select-text">110.97 Km2</p>
      </div>
      <div class="flex flex-col space-y-2 md:pr-6">
        <p class="text-xs uppercase font-semibold opacity-70 select-none">Luas Wilayah</p>
  ...
  <!-- UMKM Desa Pasiraman Section -->
  <section class="max-w-6xl mx-auto p-6 md:p-12 space-y-6">
    <div class="flex justify-between items-center mb-4">
      <h5 class="text-lg font-semibold select-none">UMKM Desa Pasiraman</h5>
    ...
    <div class="flex overflow-x-auto carousel-scrollbar space-x-4 scrollbar-hide pb-2">
      ...
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/3269c341-6ea7-4be1-a3cb-08e41aedb5af.png" alt="Colorful kites hanging on a wooden rack, outdoors with sunny sky, in a traditional kites stall" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Layangan Mas Edi</div>
      </div>
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/42833e62-9543-4bd2-a9db-6488355efe6f.png" alt="Young woman at a modern small shop preparing boba milk tea drinks with ingredients and blender visible" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Es Boba Mbak Dinda</div>
      </div>
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/76bc1077-8027-488a-af17-f3d7659fa252.png" alt="Street vendor grilling sausages over hot coals on a metal rack at a food stall" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Sosis Bakar Mas No</div>
      </div>
    </div>
  </section>

  <!-- BUMDes Desa Pasiraman Section -->
  <section class="max-w-6xl mx-auto p-6 md:p-12 space-y-6 bg-white rounded-xl shadow-md">
    <div class="flex justify-between items-center mb-4">
      <h5 class="text-lg font-semibold select-none">BUMdes Desa Pasiraman</h5>
    ...
    <div class="flex overflow-x-auto carousel-scrollbar space-x-4 scrollbar-hide pb-2">
      ...
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0 border border-gray-200">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/c238991d-8847-493a-b2c2-f340a08210f0.png" alt="Colorful kites hanging on a wooden rack, outdoors with sunny sky, in a traditional kites stall" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Layangan Mas Edi</div>
      </div>
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0 border border-gray-200">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/cb150a3d-4b2c-40b8-815a-151d8c6250bd.png" alt="Young woman at a modern small shop preparing boba milk tea drinks with ingredients and blender visible" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Es Boba Mbak Dinda</div>
      </div>
      <div class="min-w-[180px] bg-white rounded-xl shadow-md shrink-0 border border-gray-200">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/6145771f-91b8-417f-b836-3fa1b981bf46.png" alt="Street vendor grilling sausages over hot coals on a metal rack at a food stall" class="rounded-t-xl w-full h-36 object-cover" onerror="this.style.display='none'" />
        <div class="p-3 text-center text-gray-900 font-semibold text-sm select-none">Sosis Bakar Mas No</div>
      </div>
    </div>
  </section>
